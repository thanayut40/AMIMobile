...
namespace AMIMobile
{
    public partial class LoadProfilePage : ContentPage
    {
        ...
        private async void Btn_Clicked_LoadDetail(object sender, EventArgs e)
        {
            await Navigation.PushAsync(new LoadDetailPage());
        }
