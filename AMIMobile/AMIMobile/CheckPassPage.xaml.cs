...
namespace AMIMobile
{
    public partial class CheckPassPage : ContentPage
    {
        ...
        private async void Btn_Next_ChangePass(object sender, EventArgs e)
        {
            await Navigation.PushAsync(new ChangePassPage());
        }

        private async void ForgotPass_Click_2(object sender, EventArgs e)
        {
